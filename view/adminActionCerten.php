                    ...
                    <div class="row">
                        ...
                        <div class="small-4 column">
                            <select id="getStatus" name="status" >
                                <option value="1">订单操作记录</option>
                                <option value="2">司机操作记录</option>
                            </select>
                        </div>
                        <div class="small-4 column">
            ...
            <div class="panel">
                <table width="100%" id="data-user">
                    ...
                    <tr class="theData hidden">
                        <td class="small-2">admin</td>
                        <td class="small-3">2014-9-28 10:10:10</td>
                        <td class="small-2">绑定订单</td>
                        <td class="small-2">OIDxyki1</td>
                        <td class="small-2">
					...
					if(type == 1){
						for(var i = 0; i < datas.length; i++){
							if(datas[i]['type'] == 1){
									...
									$("<tr class=\"theData\">" +
											"<td class=\"small-2\">"+datas[i]['name']+"</td>" +
											"<td class=\"small-3\">"+datas[i]['time']+"</td>" +
											"<td class=\"small-2\">"+'绑定订单'+"</td>" +
											"<td class=\"small-2\">OIDxyki"+datas[i]['oid']+"</td>" +
											"<td class=\"small-2\">"+
											"<ul class=\"button-group round operation00 operation01 operation11\" >"+
											"<li><button  onclick=\"information("+datas[i]['oid']+")\" class=\"tiny button info\" >查看详情</button></li>"+
											"</ul>"+
											"</td></tr>")
						...
						for(var i = 0; i < datas.length; i++){
							if(datas[i]['type'] == 1){
								...
								$("<tr class=\"theData\">" +
										"<td class=\"small-2\">"+datas[i]['admin_name']+"</td>" +
										"<td class=\"small-4\">"+datas[i]['time']+"</td>" +
										"<td class=\"small-2\">"+datas[i]['driver_name']+"</td>" +
										"<td class=\"small-2\">"+'添加司机'+"</td>" +
										"<td class=\"small-2\">"+
										"<ul class=\"button-group round operation00 operation01 operation11\" >"+
										"<li><button  onclick=\"information2("+datas[i]['driver_id']+")\" class=\"tiny button info\" >查看详情</button></li>"+
										"</ul>"+
										"</td></tr>")
										.insertAfter($("#data-user tr:last"));
