...
<nav class="top-bar sticky" data-topbar role="navigation">
    ...
    <section class="top-bar-section">
        ...
        <ul class="left">
            ...
            <li id="adminActionDriver" class="has-dropdown active<?php
														if($_SESSION['level'] != 1)
														echo 'hidden';?>">
                    ...
                    <div class="row">
                        ...
                        <div class="small-4 column">
                            <select id="getStatus" name="status" >
                                <option value="1">添加司机</option>
                                <option value="2">修改司机</option>
                                <option value="3">删除司机</option>
                            </select>
                        </div>
                        <div class="small-4 column">
            ...
            <div class="panel">
                <table width="100%" id="data-user">
                    ...
                    <tr class="theData hidden">
                        ...
                        <td class="small-4">2014-9-28 10:10:10</td>
						 <td class="small-2">liu</td>
                    ...
                    for(var i = 0; i < datas.length; i++){
                        if(type == 1){
                            ...
                            $("<tr class=\"theData\">" +
                                    ...
                                    "<td class=\"small-2\">"+
                                    "<ul class=\"button-group round operation00 operation01 operation11\" >"+
                                    "<li><button  onclick=\"information("+datas[i]['driver_id']+")\" class=\"tiny button info\" >查看详情</button></li>"+
                                    "</ul>"+
                                    "</td></tr>")
