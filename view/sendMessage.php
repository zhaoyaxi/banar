...
<div class="container small-10" id="container" style="margin-top: 4%">
    ...
    <div class="row" style="width: 100%">
        <div class="small">
            <div class="panel">
				<label>联系手机号</label>
                <input id="phone" class="small-6">
            </div>
            <div class="panel">
				<label>发送内容</label>
                <textarea id="content" class="small-12" cols="20" lang="3"></textarea>
            </div>
            <button id="try" onclick="Htry()">try</button>
        </div>
    </div>
</div>
<script>
