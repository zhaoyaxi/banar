...
<div class="row" style="width: 100%">
    ...
    <div class="tabs-content vertical">
        <section id="card-add" class="content active">
            <div class="panel" style="margin: 0">
                <div class="row">
                    <div class="small-6 column" >
                        <label>当前优惠价格</label>
                        <input id="nowPrice" type="text" name="username" placeholder="单位：元">
                    </div>
					<div class="small-6 column" >
                        <label>新优惠价格</label>
                        <input id="newPrice" type="text" name="username" placeholder="单位：元">
                    </div>
            ...
            <div class="panel">
                ...
                <button onclick="changeCard()" class="button postfix info small" data-toggle="modal" data-target="#myModal">提交</button>
            </div>
        </section>
    </div>
</div>
