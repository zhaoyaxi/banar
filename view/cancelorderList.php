...
<nav class="top-bar sticky" data-topbar role="navigation">
    ...
    <section class="top-bar-section">
        ...
        <ul class="left">
			...
			<li id="cancelorderList" class="has-dropdown active<?php
														if($_SESSION['level'] != 1)
														echo 'hidden';?>">
                        ...
                        <tr class="theData hidden">
                            ...
                            <td class="small-4">
								<ul class="button-group round operation00 operation01 operation11" >
									...
									<li><button class="tiny button alert" data-id="0">取消订单</button></li>
								</ul>
							</td>
                        ...
                        if(type == 1){
							if(datas[i]['state'] <= 1 ){
								$("<tr class=\"theData\">" +
										...
										"<td class=\"small-3\">"+datas[i]['createTime']+"</td>" +
										"<td class=\"small-2\">"+'待取消'+"</td>" +
										"<td class=\"small-4\">"+
											"<ul class=\"button-group round operation00 operation01 operation11\" >"+
												"<li><button  onclick=\"information("+datas[i]['id']+")\" class=\"tiny button info\" >查看详情</button></li>"+
												"<li><button  onclick=\"cancelOrder("+datas[i]['id']+")\" class=\"tiny button alert\" >取消订单</button></li>"+
											"</ul>"+
										"</td></tr>")
